...
from scalable_gt import generate_mock_data, gen_gt_brute_force
...
def sweep_ivf_pq(
    ...
    for n_probes in n_probes_list:
        # Warmup
        _ = index.search(queries[:10], k, nprobes=n_probes)
...
def compare_datasets(
    ...
    if algorithm == "cagra":
        ...
        sweep_params = {"n_probes_list": [16, 32, 64, 128, 256]}
